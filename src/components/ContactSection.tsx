...
const contactInfo = [
  ...
  },
  {
    ...
    href: 'https://maps.app.goo.gl/qt159M8K3ZBGX3Xi8',
    color: 'text-blue-400'
  }
];
...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  const serviceID = 'service_vg82e1h';
  const templateID = 'template_30knuiu';
  const userID = 'KDmbGgxJy4nojEXNM'; // emailjs user public key
